      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Data Solutions</span>
            </div>
            <p className="text-slate-300 mb-4 max-w-xs">
              Transforming data into business value through expert engineering solutions for startups.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-slate-300 hover:text-white transition-colors">Cloud Data Architecture</a></li>
              <li><a href="#" className="text-slate-300 hover:text-white transition-colors">ETL/ELT Pipelines</a></li>
              <li><a href="#" className="text-slate-300 hover:text-white transition-colors">Real-time Processing</a></li>
              <li><a href="#" className="text-slate-300 hover:text-white transition-colors">Cost Optimization</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-slate-300 hover:text-white transition-colors">Data Engineering Guide</a></li>
        ...
        <div className="border-t border-slate-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-slate-400">
            &copy; {new Date().getFullYear()} IV Data Solutions. All rights reserved.
          </p>
